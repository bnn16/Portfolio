    ...
    <div className='min-h-screen z-10 text-accent'>
      <div className='p-10 flex flex-col'>
        <div className='md:flex'>
          <h1 className='text-5xl font-bold underline-offset-8 underline decoration-flame'>
            Experience.
          </h1>
        </div>
        <div className='mt-6 space-y-12 w-full flex flex-col justify-center'>
          <div>
            ...
            <p className='mt-2'>
              I am currently studying ICT Software Engineering and Cybersecurity
              at Fontys University of Applied Sciences. I am in my second year
              of studies and I am enjoying it a lot. <br />I made a project for
              a company called Ordina, which is a web application that allows
              their employees to check-in and check-out of which office they are
              working and going to work from.
            </p>
          ...
          <div>
            ...
            <p className='mt-2'>
              For my graduation project I made a web application that allows the
              students to study for the final technical exams for special
