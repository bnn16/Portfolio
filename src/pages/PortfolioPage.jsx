  ...
  const sections = [
    {
      ...
      content: (
        <p className="mb-4">
          ...
          I`ve embarked upon in the world of programming.
          {' '}
          <br />
        </p>
      ),
      ...
      content: (
        <div className="flex flex-col flex-grow gap-2">
          ...
          <ul className="list-disc">
            <li>
              <span className="text-accent">#FFFCF2:</span>
              {' '}
              Draws attention to
              key elements with a warm and bright hue.
            </li>
            <li>
              <span className="text-accent-light">#CCC5B9:</span>
              {' '}
              Complements
              the accent, adding depth and subtlety to the design.
            </li>
            <li>
              <span className="text-flame">#EB5E28:</span>
              {' '}
              Infuses energy and
              warmth, creating a vibrant focal point.
            </li>
            <li>
              <span className="text-flame-dark">#C8491E:</span>
              {' '}
              Adds depth and
              contrast, enhancing visual hierarchy.
            </li>
            <li>
              <span className="text-background-light">#403D39:</span>
              {' '}
              Provides a
